...
const budgetOptions = [
  { value: "0-100", label: "0 - 100 ezer Ft" },
  { value: "100-300", label: "100 - 300 ezer Ft" },
  { value: "300-500", label: "300 - 500 ezer Ft" },
  { value: "500+", label: "500 ezer Ft felett" },
  { value: "unknown", label: "Nem tudom még" }
];
            ...
            <div className="bg-white rounded-xl shadow-lg border p-8">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <Select>
                    <SelectTrigger>
                      <SelectValue placeholder="Válasszon költségkeretet" />
                    </SelectTrigger>
                    <SelectContent>
